...
- Next step: build the wallet with the updated Git pin and complete the above device acceptance before closing this release blocker. Source-level fixes are not a new TestFlight upload.
